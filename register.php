...
$username = $password = $email= $confirm_password = $confirm_email = "";
...
<div class="wrapper">
    ...
    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
        ...
        <div class="form-group">
            ...
            <input type="text" name="confirm_email" class="form-control <?php echo (!empty($email_err_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $confirm_email; ?>">
